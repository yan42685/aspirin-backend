...
(
    ...
    `number`              varchar(255) unique not null comment '工号',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
...
(
    ...
    `status`              varchar(255)        NOT NULL DEFAULT '0' COMMENT '用户账号状态',
    `role`                tinyint             not null comment '角色',
    `number`              varchar(255) unique not null comment '教师编号',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
...
(
    ...
    `real_name`           varchar(255)        NOT NULL DEFAULT '' COMMENT '姓名',
    `gender`              tinyint             not null default 0 comment '性别',
    `faculty_number`      varchar(255)        not null comment '学院',
    `specialty_number`    varchar(255)        not null comment '专业',
    `phone_number`        varchar(255)        NOT NULL DEFAULT '' COMMENT '手机号',
    `contact_information` varchar(255)        NOT NULL DEFAULT '' COMMENT '其他联系方式, 比如qq或邮箱等',
    `nickname`            varchar(255)        NOT NULL DEFAULT '' COMMENT '昵称',
    `avatar_url`          varchar(255)        NOT NULL DEFAULT '' COMMENT '头像URL',
    `status`              varchar(255)        NOT NULL DEFAULT '0' COMMENT '用户账号状态',
    `role`                tinyint             not null comment '角色',
    `number`              varchar(255) unique not null comment '学号',
...
(
    ...
    regular_scores   decimal      not null comment '平时分',
    exam_scores      decimal      not null comment '考试分',
...
(
    ...
    number        varchar(255) unique not null comment '编号',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
